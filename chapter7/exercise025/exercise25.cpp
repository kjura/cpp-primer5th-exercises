...
int main()
{
    ...
    Screen scr('a', 10, 11);
    point_state(cout, scr) << "\n\n";

    //assignment operator that copies scr to my_cp
    Screen my_cp = scr; 

    //print my_cp --> Ok, after assignment things printed are indentical, compiler synthesized this operation for us
    // due to fundamental types included as data members string and unsigned
    point_state(cout, my_cp) << "\n\n";
